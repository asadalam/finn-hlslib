...
cp hls-syn-mvau-stream-binwgt/sol1/csim/build/{inp_act.memh,inp_wgt.memh,out_act.memh} ../../proj/sim/
...
python extract_synthesis_data.py -o mvau_stream_binwgt_results.csv
cd $FINN_HLS_ROOT/tb
exit 1
